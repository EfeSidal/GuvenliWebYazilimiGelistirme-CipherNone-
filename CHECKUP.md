...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/Technical_Depth-48-purple?style=for-the-badge" alt="Tech Depth"/>
</div>

| Attribute           | Value                                 |
| :------------------ | :------------------------------------ |
| **Student**         | `Efe Sidal` (`2420191004`) |
| **Course**          | `secure-web`                       |
...
| :--------------------- | :----------------: | :--------: | :---------------------------------------------------------------------- |
| **Technical Depth**    | `48`  |     25     | _(Röntgen Analizi)_ Deep structural / architectural execution.          |
